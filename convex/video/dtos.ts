import { z } from "zod";
import { createdVideoValidator, createVideoValidator, updateVideoValidator, videoDetailsValidator, videoListItemValidator } from "./validators";

export type CreateVideoDTO = z.infer<typeof createVideoValidator>;

export type CreatedVideoDTO = z.infer<typeof createdVideoValidator>
